...
export function SettingsScreen() {
  ...
  function runYearReset() {
    void resetForNewYear({ money: true });
  ...
  return (
    <>
      ...
      <div className="section-title">
        Budget categories
        <HelpTip text="Add, rename, or remove the color tags your budget lines can be filed under. Tap a tag's name to rename it, or tap its dot to change its color." />
      </div>
      <div className="card" data-tour="settings-categories">
        <p className="muted settings-hint">
          Just a color and label to organize your income, bills, and expenses.
        </p>
        {categories.length > 0 && (
      ...
      <div className="section-title">
        Start a fresh year
        <HelpTip text="Starting a new year? Clear out this year's transactions and start clean, no rebuilding your budget. Your savings funds, debts, budget periods, and settings all stay exactly as they are." />
      </div>
      <div className="card" data-tour="settings-yearreset">
        <p className="muted settings-hint">
          Clears this year's budget transactions so you can start the new year
          with a clean ledger. Your savings funds, debts, and settings stay.
      ...
      <BottomSheet open={yearResetOpen} title="Start a fresh year" onClose={() => setYearResetOpen(false)}>
        <p className="muted settings-sheet-note">
          This clears every budget transaction from this year: income, bills,
          and expenses across all periods. Your savings funds, debts, and
          settings stay exactly as they are. This can't be undone.
        </p>
        <button className="btn btn--primary" onClick={runYearReset}>
          Clear this year's transactions
        </button>
      </BottomSheet>
